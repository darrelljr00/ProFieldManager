...
const PublicPromotionsPage = lazy(() => import("@/pages/public-promotions"));
...
const TechnicianEndOfDay = lazy(() => import("@/pages/technician-end-of-day"));
        ...
        <main className="flex-1 overflow-y-auto">
          <Suspense fallback={<PageLoader />}>
            <Switch>
              ...
              <Route path="/end-of-day" component={TechnicianEndOfDay} />
    ...
    <div className="min-h-screen bg-background">
      <Suspense fallback={<PageLoader />}>
        <Switch>
          ...
          <Route path="/promotions" component={PublicPromotionsPage} />
