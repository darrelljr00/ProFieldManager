...
export default function PublicQuotePayment() {
  ...
  const handlePaymentSuccess = (paymentIntentId: string) => {
    setLocation(`/payment/success?type=quote&id=${quoteId}&pi=${paymentIntentId}`);
  };
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your card details to accept this quote and complete payment
              </CardDescription>
            </CardHeader>
            <CardContent>
              <StripeCheckoutForm
