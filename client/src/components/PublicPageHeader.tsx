      ...
      <header className="absolute top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-md border-b border-white/20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-white hover:text-blue-200 transition-colors" data-testid="nav-link-home">Home</Link>
            <Link href="/features" className="text-white hover:text-blue-200 transition-colors" data-testid="nav-link-features">Features</Link>
            <Link href="/features#pricing" className="text-white hover:text-blue-200 transition-colors" data-testid="nav-link-pricing">Pricing</Link>
            <Button variant="outline" className="border-white text-white hover:bg-white hover:text-slate-900" asChild data-testid="button-nav-login">
              <Link href="/login">Login</Link>
            </Button>
            <Button className="bg-blue-600 hover:bg-blue-700 text-white" asChild data-testid="button-nav-get-started">
            ...
            <div className="container mx-auto px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <Link href="/login" onClick={() => setMobileMenuOpen(false)}>
                  <Button variant="outline" className="w-full border-slate-900 text-slate-900 hover:bg-slate-900 hover:text-white" data-testid="mobile-button-login">
                    Login
                  </Button>
                </Link>
                <Link href="/features#signup" onClick={() => setMobileMenuOpen(false)}>
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" data-testid="mobile-button-get-started">
                    Get Started
                  </Button>
                </Link>
              </div>
