...
- July 23, 2025. PHOTO BUTTON STYLING FIX: Restored green color to all photo and upload buttons across the application - updated "Upload File" button in project details, "Upload Image" button in image gallery, while "Take Photo" buttons were already properly styled with green background (bg-green-600 hover:bg-green-700) for consistent visual identification of photo-related actions
