                          ...
                          <div className="flex space-x-2" onClick={(e) => e.stopPropagation()}>
                            ...
                            {expense.receiptUrl && (
                              <Button size="sm" variant="ghost" asChild>
                                <a href={expense.receiptUrl.startsWith('uploads/') ? `/${expense.receiptUrl}` : expense.receiptUrl} target="_blank" rel="noopener noreferrer">
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <Button variant="outline" size="sm" asChild>
                          <a href={selectedExpense.receiptUrl.startsWith('uploads/') ? `/${selectedExpense.receiptUrl}` : selectedExpense.receiptUrl} target="_blank" rel="noopener noreferrer">
